...
Для биржах Wex и Liqui комиссия берется с сервера биржи, поэтому в ручном изменении нет необходимости.
...
Пока работает только проверка количество ордеров в сетке и частичная проверка активных ордеров.
