...
> Если параметр **FIRST_LOADING_HISTORY** включен, будет загружены в кэш первые 30 BUY ордеров до первого SELL ордера на выбраной паре и выставится SELL ордер исходя из этих данных.
