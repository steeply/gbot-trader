...
EXCHANGE                | Выбор биржи **btc-e**, **poloniex** или **bittrex** (default: btc-e)
...
#### Используемые торговые параметры
...
DELAY_REQUEST_API           | Задержка при выполнении запросов к api в миллисекундах (default: 500)
