...
BBANDS_INTERVAL                     | Таймфрейм. Интервал запроса цен (в минутах)<br>Используйте значения доступные на бирже. | number | 1
...
* URL_INDICATOR - указывается URL адрес сервера с внешними сигналами.
