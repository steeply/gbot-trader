...
OFFSET_ORDERS_POINTS                | Отступ между ордерами в пунктах 
OFFSET_ORDERS_PERCENT               | Отступ между ордерами в процентах (default: 1)
...
> Если задан **OFFSET_ORDERS_PERCENT**, тогда действие **OFFSET_ORDERS_POINTS** отменяется.
...
ONE_ORDERS_SELL_PERCENT             | Насколько увеличить среднюю цену продажи в процентах (default: 1)
